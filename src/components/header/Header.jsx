...
import { format } from "date-fns"; //this transforms the date to readable strings
                    ...
                    <>
                        ...
                        <div className="headerSearch">
                            ...
                            <div className="headerSearchItem">
                                ...
                                <span className="headerSearchText" onClick={() => setopenCal(!openCal)}>{`${format(date[0].startDate, "dd/MM/yyyy")} 
